...
import static com.itech.core.Constants.NATIVE_DIR;
import static com.itech.core.Constants.OPTIMIZE_DIR;
...
public class Core {
    ...
    public static ClassLoader createClassLoader(Context context, File apk, ClassLoader parent) throws Exception {
        File libsDir = getDir(context, NATIVE_DIR);
        File dexOutputDir = getDir(context, OPTIMIZE_DIR);
        String dexOutputPath = dexOutputDir.getAbsolutePath();
        DexClassLoader loader = new DexClassLoader(apk.getAbsolutePath(), dexOutputPath, libsDir.getAbsolutePath(), parent);

        //if (Constants.COMBINE_CLASSLOADER) {
        insertDex(loader, parent, libsDir);
        //}
