...
public class MediaLayout extends RelativeLayout {
     ...
     */
    public void initForVideo(boolean openNewActivityPlay) {
        if (mIsInitialized) {
            return;
        }
        ...
        if (mVideoTextureView != null) {
            ...
            final GradientDrawable bottomGradientDrawable =
                    new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP,
                            new int[]{DrawableConstants.GradientStrip.START_COLOR, DrawableConstants.GradientStrip.END_COLOR});
