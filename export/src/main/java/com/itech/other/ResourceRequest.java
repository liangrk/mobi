...
public class ResourceRequest<T extends DownloadTask> {
    ...
    public ResourceRequest setTitle(@NonNull String title){
        mDownloadTask.setTitle(title);
        return this;
    }
    ...
    public ResourceRequest setExtData(Serializable extData) {
        mDownloadTask.mExtData = extData;
        return this;
    }
