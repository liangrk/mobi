...
public final class Runtime {
	...
	public Intent getCommonFileIntentCompat(Context context, DownloadTask downloadTask) {
		...
		setIntentDataAndType(context, mIntent, getMIMEType(downloadTask.getFile()), downloadTask.getFile(),
				false, downloadTask.isCustomFile() ? downloadTask.getAuthority() : getAuthority(downloadTask.getContext()));

			System.out.println("文件存在..."+downloadTask.getFile().getAbsolutePath());
...
//		System.out.println("FileProvider:" +authority + ",,"+file.getAbsolutePath());
		Uri uri = null;
